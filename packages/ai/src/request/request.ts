import { createStreamParser, getParser } from "../parser/index.js";
import { processResult } from "../parser/stream.js";
 ...
 */
export function createRequest(token: string, isStream = true, observer: RequestObserver = {}) {
  // 请求控制器
