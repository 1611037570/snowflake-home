...
<template>
  ...
  >
    ...
    <div class="absolute -top-10 right-[-64px] h-22 w-6 rotate-38 rounded-full bg-[#008bb2]"></div>
    <div
  ...
  <div class="relative z-4 flex flex-col items-center gap-2 text-[78px] font-black">
    <div class="text-sf-text drop-shadow-[0_10px_28px_rgba(0,0,0,0.22)]">找工作</div>
    <div class="text-sf-theme not-italic">从一份好简历开始</div>
    <div class="text-xl font-extrabold text-sf-text-2">打动HR的专业简历，抓住每一个高薪机会</div>
    <div
      class="flex h-[58px] w-[168px] cursor-pointer items-center justify-center rounded-full border-0 bg-sf-theme text-[22px] font-black text-sf-theme-text shadow-lg shadow-sf-theme/25 transition-all duration-200 hover:-translate-y-0.5 hover:bg-sf-theme-hover max-[900px]:w-[188px]"
      @click="handleCreate"
    >
      立即制作
    </div>
