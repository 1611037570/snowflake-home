<template>
  <div class="hero-book absolute bottom-0 left-0 z-2 h-[600px]">
    <div
    ...
    ></div>
    <div class="absolute top-20 bottom-6 left-20 w-[130px] rounded-xl bg-sf-theme-2"></div>
    <div
...
.hero-book {
  animation: hero-slide-right 0.82s cubic-bezier(0.2, 0.8, 0.2, 1) both;
}
