<template>
  <div class="min-h-screen w-full bg-sf-page font-sans text-sf-text">
    <!-- 导航栏 -->
    <nav
      v-if="0"
      ...
      <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div class="hidden items-center gap-8 text-sm md:flex">
          ...
          <a href="#editor" class="text-sf-text-2 transition-colors hover:text-sf-text"
            >云帆编辑器</a
          >
          <a href="#stats" class="text-sf-text-2 transition-colors hover:text-sf-text">星轨统计</a>
    ...
    >
      ...
      >
        <div class="text-center lg:text-left">
          ...
          <!-- 副标题 -->
          <h2 class="mb-10 text-3xl leading-snug font-bold tracking-tight text-sf-text md:text-4xl">
