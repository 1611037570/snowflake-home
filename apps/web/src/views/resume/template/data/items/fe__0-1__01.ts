...
export const englishResumeItem: any = {
  data: {
    user: { ui: { archived: false }, data: { position: "Software Engineer", name: "Ethan Chen", birthday: "2000-09", phone: "+86 138****7821", email: "ethan.chen@example.com", workTime: "2022.08.01", sex: "Male", avatar: xiaoyang } },
    ...
    education: { ui: { collapsed: ["1"], archived: false }, list: [{ ui: {}, data: { name: "*** University", education: "Bachelor's Degree", post: "Computer Science", startTime: "2018.09", endTime: "2022.06", content: "<p>Coursework: Data Structures, Web Development and Software Engineering.</p>", mode: "Full-time" } }] },
