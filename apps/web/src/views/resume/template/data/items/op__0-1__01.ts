...
export const internshipZeroToOneResumeItem: any = {
  data: {
    user: { ui: { archived: false }, data: { position: "产品运营实习生", name: "许宁", birthday: "2002-08", phone: "136****5603", email: "xuning@example.com", workTime: "2025.07.01", sex: "女", avatar: xiaozhou } },
    ...
    education: { ui: { collapsed: ["1"], archived: false }, list: [{ ui: {}, data: { name: "***大学", education: "本科", post: "市场营销", startTime: "2021.09", endTime: "2025.06", content: "<p>主修消费者行为、市场调研与数字营销。</p>", mode: "全日制" } }] },
