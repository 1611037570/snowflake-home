<template>
  <div class="h-full w-full">
    <div
      class="flex-c relative h-full w-full rounded-xl border border-sf-theme-2 bg-sf-primary transition-all hover:border-sf-theme hover:shadow-xl"
      ref="containerRef"
    >
      <div
        v-if="isShowImage"
      ...
      >
        <div
          v-if="label"
          class="flex-c text-sf-basic bg-sf-page rounded-full px-2 py-0.5 font-bold"
        >
          <span>{{ label }}</span>
        </div>
