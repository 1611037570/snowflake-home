...
export const ICON_LIST: Record<string, IconItem> = {
  ...
  "bi:shield-exclamation": { icon: "bi:shield-exclamation" },
  "bi:shield-check": { icon: "bi:shield-check" },
  "lucide:camera": {
    icon: "lucide:camera",
  },
  ...
  "mdi:map-search-outline": { icon: "mdi:map-search-outline", name: "模块导航" },
  ...
  "icon-park-outline:drag": { icon: "icon-park-outline:drag", name: "拖动" },
  ...
  "lucide:swatch-book": { icon: "lucide:swatch-book" },
  "lucide:contrast": { icon: "lucide:contrast", name: "黑白对比" },
  ...
  "lucide:archive": { icon: "lucide:archive" },
  "lucide:archive-restore": { icon: "lucide:archive-restore" },
  ...
  "mdi:school": { icon: "mdi:school", name: "学校实心" },
  "mdi:book-open-page-variant": { icon: "mdi:book-open-page-variant", name: "翻开的书" },
  "mdi:notebook-outline": { icon: "mdi:notebook-outline", name: "笔记本" },
  "ph:graduation-cap-duotone": { icon: "ph:graduation-cap-duotone", name: "毕业帽" },
  "mdi:briefcase-clock": { icon: "mdi:briefcase-clock", name: "商务时钟" },
  "mdi:office-building": { icon: "mdi:office-building", name: "办公楼" },
  "ph:briefcase-duotone": { icon: "ph:briefcase-duotone", name: "公文包双色" },
  "mdi:code-braces": { icon: "mdi:code-braces", name: "代码花括号" },
  "mdi:atom": { icon: "mdi:atom", name: "原子" },
  "mdi:trophy-outline": { icon: "mdi:trophy-outline", name: "奖杯" },
  "mdi:medal-outline": { icon: "mdi:medal-outline", name: "勋章" },
  "mdi:certificate-outline": { icon: "mdi:certificate-outline", name: "证书" },
  "material-symbols:workspace-premium-outline": { icon: "material-symbols:workspace-premium-outline", name: "获奖" },
  "mdi:palette": { icon: "mdi:palette", name: "调色板" },
  "mdi:gamepad-variant": { icon: "mdi:gamepad-variant", name: "游戏手柄" },
  "mdi:wechat": { icon: "mdi:wechat", name: "微信" },
