...
| 断点前缀 | 最小宽度 | 适用设备          | 核心使用场景           |
| -------- | -------- | ----------------- | ---------------------- |
| 无前缀   | 0px      | 移动端（默认）    | 所有设备的基础样式     |
| sm:      | 640px    | 大屏手机          | 移动端到平板的过渡适配 |
| md:      | 768px    | 平板              | 平板专属布局 / 样式    |
| lg:      | 1024px   | 小屏桌面 / 笔记本 | 桌面端基础适配         |
| xl:      | 1280px   | 大屏桌面          | 大屏桌面布局优化       |
| 2xl:     | 1536px   | 超大屏桌面        | 超宽屏内容排版调整     |
